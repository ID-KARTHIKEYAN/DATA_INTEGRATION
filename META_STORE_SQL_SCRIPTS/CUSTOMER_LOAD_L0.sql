...
-- Group     : CUSTOMER_LOAD_L0
-- Bundle    : [v1.0] [untagged] deployed: 2026-06-23 03:49 | branch: main | layer: L0
-- ==============================================
...
USING (SELECT 'CUSTOMER_LOAD_L0' AS DATA_FLOW_GROUP_ID, 'https://drive.usercontent.google.com/download?id=1ZhkFBGg-y7uKqHDYiMOp0R4jzGiPQ9Yf&export=download&confirm=t' AS SOURCE_URL, 'bronze' AS TARGET_SCHEMA, 'cus_data' AS TARGET_TABLE, 'csv' AS FILE_FORMAT, 'FULL' AS LOAD_TYPE, 'Y' AS IS_ACTIVE, current_timestamp() AS CREATED_DATE, current_timestamp() AS UPDATED_DATE) AS src
