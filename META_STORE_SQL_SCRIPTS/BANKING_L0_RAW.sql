...
-- Group     : BANKING_L0_RAW
-- Bundle    : [v1.0] [untagged] deployed: 2026-06-23 03:48 | branch: main | layer: ALL
-- ==============================================
...
USING (SELECT 'BANKING_L0_RAW' AS DATA_FLOW_GROUP_ID, 'https://raw.githubusercontent.com/swapniltake1/data-engineering-practice-datasets/refs/heads/main/CSV/banking.csv' AS SOURCE_URL, 'bronze' AS TARGET_SCHEMA, 'bank_data' AS TARGET_TABLE, 'csv' AS FILE_FORMAT, 'FULL' AS LOAD_TYPE, 'Y' AS IS_ACTIVE, current_timestamp() AS CREATED_DATE, current_timestamp() AS UPDATED_DATE) AS src
