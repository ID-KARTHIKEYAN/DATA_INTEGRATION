...
-- Group     : WEATHER_L0
-- Generated : 2026-06-18 05:05:17
-- ==============================================

MERGE INTO demo_catalog.admin.data_flow_control_header AS tgt
USING (
  SELECT
    'WEATHER_L0'           AS DATA_FLOW_GROUP_ID,
    'WEATHER_L0_JOB'       AS JOB_NAME,
    '/Workspace/Users/svkarthick0@gmail.com/DATA_INTEGRATION/notebooks/run_framework'      AS NOTEBOOK_PATH,
    'Y'                    AS IS_ACTIVE,
