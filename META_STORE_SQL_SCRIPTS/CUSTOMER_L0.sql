...
-- Group     : CUSTOMER_L0
-- Generated : 2026-05-24 14:10:49
-- ==============================================

MERGE INTO demo_catalog.admin.data_flow_control_header AS tgt
USING (
  SELECT
    'CUSTOMER_L0'           AS DATA_FLOW_GROUP_ID,
    'CUSTOMER_L0_JOB'       AS JOB_NAME,
...
USING (
  SELECT
    'CUSTOMER_L0'  AS DATA_FLOW_GROUP_ID,
    'https://raw.githubusercontent.com/mwaskom/seaborn-data/master/titanic.csv'     AS SOURCE_URL,
    'bronze'     AS TARGET_SCHEMA,
    'titanic_data'     AS TARGET_TABLE,
    'csv'     AS FILE_FORMAT,
    'FULL'     AS LOAD_TYPE,
    'Y'           AS IS_ACTIVE,
    current_timestamp() AS CREATED_DATE,
